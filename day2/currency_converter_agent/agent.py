...
fee_tool = FunctionTool(func=get_fee_for_payment_method)
rate_tool = FunctionTool(func=get_exchange_rate)
...
calculation_agent  = LlmAgent(
    ...
    instruction="""You are a specialized calculator that ONLY responds with Python code. You are forbidden from providing any text, explanations, or conversational responses.
     ...
     The output should be python function: 
     def calculate_amount_after_exchange(fee_rate: float, exchange_rate: float, original_amount: float) -> float:
